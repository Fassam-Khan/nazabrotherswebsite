...
export const getProductByBestDeal = async (slug) => {
  try {
    const response = await fetch(`https://nazarbrothers.pk/wp-json/wc/store/v1/products/daler-rowney-simply-mini-wooden-table-easel-12inches/`, {
      headers: getAuthHeader(),
      next: { revalidate: 60 },
    });
